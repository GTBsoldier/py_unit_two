...
if origin in ("maryland", "Maryland", "DC", "Washington DC", "Iran", "South Sudan", "North Korea"):
    print("Oh, I really hate people from there,")
else:print("O thats cool")
print("")
...
print("Wow, very cool. I think that a",fav_car,"is an intersting choice.")
print("")
